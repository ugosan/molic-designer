...
public class UbiquitousAccessItemProvider
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_UbiquitousAccess_name_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_UbiquitousAccess_name_feature", "_UI_UbiquitousAccess_type"),
                 MolicPackage.Literals.UBIQUITOUS_ACCESS__NAME,
                 false,
                 false,
                 false,
                 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public String getText(Object object) {
        String label = ((UbiquitousAccess)object).getName();
