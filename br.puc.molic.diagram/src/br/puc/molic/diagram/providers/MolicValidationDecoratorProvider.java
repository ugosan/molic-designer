...
import br.puc.molic.diagram.part.ValidationMarker;

/**
 * @generated
 */
public class MolicValidationDecoratorProvider extends AbstractProvider
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof MolicDiagramEditor) {
