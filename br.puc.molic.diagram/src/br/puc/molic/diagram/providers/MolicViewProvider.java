...
import br.puc.molic.diagram.view.factories.UbiquitousAccessLabelViewFactory;
 ...
 * @generated
 */
public class MolicViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = MolicVisualIDRegistry.getNodeVisualID(op
					.getContainerView(), domainElement);
		} else {
			visualID = MolicVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
		...
		return SceneEditPart.VISUAL_ID == visualID
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case SceneEditPart.VISUAL_ID:
			return createScene_2007(domainElement, containerView, index,
					persisted, preferencesHint);
		case SystemProcessEditPart.VISUAL_ID:
			return createSystemProcess_2008(domainElement, containerView,
					index, persisted, preferencesHint);
		case UbiquitousAccessEditPart.VISUAL_ID:
			return createUbiquitousAccess_2010(domainElement, containerView,
					index, persisted, preferencesHint);
		case OpeningPointEditPart.VISUAL_ID:
			return createOpeningPoint_2011(domainElement, containerView, index,
					persisted, preferencesHint);
		case ClosingPointEditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (MolicVisualIDRegistry.getVisualID(elementTypeHint)) {
		case UtteranceEditPart.VISUAL_ID:
			return createUtterance_4001(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case BRTUtteranceEditPart.VISUAL_ID:
			return createBRTUtterance_4002(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createScene_2007(EObject domainElement, View containerView,
		...
		node.setType(MolicVisualIDRegistry.getType(SceneEditPart.VISUAL_ID));
		...
		Node label5004 = createLabel(node, MolicVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createSystemProcess_2008(EObject domainElement,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(MolicVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createUbiquitousAccess_2010(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		Node label5007 = createLabel(node, MolicVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createOpeningPoint_2011(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createClosingPoint_2012(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	...
	public Edge createUtterance_4001(EObject domainElement, View containerView,
		...
		Node label6001 = createLabel(edge, MolicVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createBRTUtterance_4002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(MolicVisualIDRegistry
		...
		Node label6002 = createLabel(edge, MolicVisualIDRegistry
