 ...
 * @generated
 */
public class SceneTopicEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SceneTopicEditPart(View view) {
		super(view);
	}
			...
			parser = MolicParserProvider
					.getParser(
							...
							MolicVisualIDRegistry
									.getType(br.puc.molic.diagram.edit.parts.SceneTopicEditPart.VISUAL_ID));
		}
		return parser;
	}
